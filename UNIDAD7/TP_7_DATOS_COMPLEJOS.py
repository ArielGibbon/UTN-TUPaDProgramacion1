...
#Se crea el diccionario usando las tuplas de key(dia y hora) y los eventos de value
agenda = {
    ("lunes", "10:00"): "Clases de la Facu",
    ("martes", "10:00"): "Reunión de trabajo",
    ("miercoles", "10:00"): "Gym",
    ("jueves", "22:00"): "Fútbol con los pibes",
    ("viernes", "22:00"): "Cena de amigos"
}
##un bucle while para hacer el menu
while True:
    ...
    if opcion == "1":
        dia = input("Ingresá el día: (en minúsculas)")
